...
/**
 * A horizontal/vertical bar chart that is rendered within the browser using SVG or VML. Displays tips when hovering over bars.
 */
public class MaterialBar extends CoreChartWidget<BarChartOptions> {
	...
	protected native ChartObject createChartObject(Element container) /*-{
		return new $wnd.google.charts.Bar(container);
	}-*/;
}
